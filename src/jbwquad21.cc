...
dcomplex jbwquad21(dcomplex (*f)(const dcomplex),const dcomplex a,
 ...
 label2:
  ...
  std::cout << "jbwquad21 too high accuracy required\n";
  return result;
label5:
  result= result+s2;
  if(bb != b) goto label1;

...
void jbdadmul(double (*f)(double x[],void* ),void* ap,const int n,double a[],double b[],
...
double jbdad2(double (*fcn)(double x[],void*),void* ap,double a[],double b[],
...
double jbdad3(double (*fcn)(double x[],void*),void* ap, double a[],double b[],
	      const double releps, double &relerr,int &ifail){
  const int ndim = 3;
...
double jbdad4(double (*fcn)(double x[],void*),void* ap,double a[],double b[],
	      const double releps, double &relerr,int &ifail){
  const int ndim = 4;
...
void jbdadmul(double (*f)(double x[],void* ),void* ap, const int n,double aa[],double bb[],
	    const int minpts,const int maxpts,const double eps,double wk[],
	    const int iwk,double &result,double &relerr,
	    int &nfnevl,int &ifail){
